...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'signin.php?action=logout', 'login' ) );
...
function wp_login_url( $redirect = '', $force_reauth = false ) {
	$login_url = site_url( 'signin.php', 'login' );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'signin.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form =
		sprintf(
			...
			esc_url( site_url( 'signin.php', 'login_post' ) )
		) .
		$login_form_top .
		sprintf(
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	if ( is_multisite() ) {
		...
		$wp_login_path = $blog_details->path . 'signin.php';
	} else {
		$wp_login_path = 'signin.php';
	}
